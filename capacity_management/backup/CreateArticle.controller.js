...
*/
	...
	var factor_name = sap.ui.getCore().byId("FacName");
	console.log(Facdata[0].FACTOR_NAME);
	factor_name.setValue(Facdata[0].FACTOR_NAME);
	var factor_id =sap.ui.getCore().byId("FacID");
	factor_id.setValue(Facdata[0].FACTOR_GUID)
	var factor_type =sap.ui.getCore().byId("FacTYPE");
	factor_type.setValue(Facdata[0].FACTOR_TYPE)
	var factor_type =sap.ui.getCore().byId("UserName");
...
//	}
	...
	//	console.log(err.response.body);
       ...
       "FACTOR_NAME":data.FACTOR_NAME,
	   "CREATE_ON":new Date(),
	   "CREATE_BY":sap.ui.getCore().byId("UserName").getValue(),
	   "ARTICLE_CONTENT":sap.ui.getCore().byId("NTx").getValue(), 
	   "ARTICLE_TITLE":sap.ui.getCore().byId("ArcTitle").getValue(),
			}
