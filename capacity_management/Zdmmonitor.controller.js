...
var oModel = sap.ui.getCore().getModel("BsChart");
	...
	zdmdescription.setValue("Factor "+zdmdata[0].FACTOR_BUSINESS_NAME+" has been configured for the monitoring. Factor Name ："+zdmdata[0].FACTOR_NAME+ "|Type: "+ftype);
